  ...
  return (
    <Container>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "end" }}>
        <Button kind={KIND.tertiary} size={SIZE.compact} onClick={() => { editor.history.reset() }} title="Reset History">
          <Icons.Refresh size={16} />
        </Button>
        <Button kind={KIND.tertiary} size={SIZE.compact} onClick={() => { editor.history.undo() }} title="Undo">
          <Icons.Undo size={22} />
        </Button>
        <Button kind={KIND.tertiary} size={SIZE.compact} onClick={() => { editor.history.redo() }} title="Redo">
          <Icons.Redo size={22} />
        </Button>
        {/* <Button kind={KIND.tertiary} size={SIZE.compact}>
